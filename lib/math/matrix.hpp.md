...
data:
  ...
  bundledCode: "#line 2 \"lib/math/matrix.hpp\"\n\n/**\n * @brief Matrix\n * @docs\
    ...
    \ val.begin() + i * m; }\n    auto operator[](int i) const { return val.begin()\
    \ + i * m; }\n    inline Matrix& operator+=(const Matrix &rhs){\n        for(int\
    \ i = 0; i < n * m; ++i){\n            val[i] += rhs[i];\n        }\n        return\
    \ *this;\n    }\n    inline Matrix& operator-=(const Matrix &rhs){\n        for(int\
    \ i = 0; i < n * m; ++i){\n            val[i] -= rhs[i];\n        }\n        return\
    ...
    \  friend inline Matrix operator-(const Matrix& lhs, const Matrix& rhs) noexcept\
    \ { return Matrix(lhs) -= rhs; }\n    friend inline bool operator==(const Matrix&\
    \ lhs, const Matrix& rhs) noexcept { return lhs.val == rhs.val; }\n    friend\
    \ inline bool operator!=(const Matrix& lhs, const Matrix& rhs) noexcept { return\
