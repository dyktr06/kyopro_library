...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/ntl/ntl_2_b.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_2_B\"\
    ...
    \ }\n};\n#line 6 \"test/aoj/ntl/ntl_2_b.test.cpp\"\n\nint main(){\n    BigInt\
    \ a, b; cin >> a >> b;\n    cout << a - b << \"\\n\";\n}\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/ntl/ntl_2_b.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/ntl/ntl_2_b.test.cpp
- /verify/test/aoj/ntl/ntl_2_b.test.cpp.html
