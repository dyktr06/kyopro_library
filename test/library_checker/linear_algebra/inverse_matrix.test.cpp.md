...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/linear_algebra/inverse_matrix.test.cpp\"\
    ...
    \    Matrix res(m, n), a = *this;\n        for(int i = 0; i < m; ++i){\n     \
    \       for(int j = 0; j < n; ++j){\n                res[i][j] = a[n - j - 1][i];\n\
    \            }\n        }\n        return res;\n    }\n};\n#line 7 \"test/library_checker/linear_algebra/inverse_matrix.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/library_checker/linear_algebra/inverse_matrix.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/linear_algebra/inverse_matrix.test.cpp
- /verify/test/library_checker/linear_algebra/inverse_matrix.test.cpp.html
