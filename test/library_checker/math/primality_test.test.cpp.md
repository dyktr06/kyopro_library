...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/math/primality_test.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/primality_test\"\n#include <bits/stdc++.h>\n\
    ...
    \        for(int j = 0; j < cnt; ++j){\n                    z *= x;\n        \
    \            ret.push_back(z);\n                }\n            }\n        }\n\
    \        return ret;\n    }\n}\n#line 6 \"test/library_checker/math/primality_test.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2024-05-05 01:51:58+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/library_checker/math/primality_test.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/math/primality_test.test.cpp
- /verify/test/library_checker/math/primality_test.test.cpp.html
