...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/number_theory/bell_number.test.cpp\"\
    ...
    \ { return os << x.val; }\n};\n#line 2 \"lib/math/bell_number.hpp\"\n\n/**\n *\
    ...
    \ + 1);\n    f[0] -= 1;\n    f = f.exp(n + 1);\n\n    T fact = 1;\n    for(int\
    \ i = 0; i <= n; i++){\n        if(i) fact *= i;\n        f[i] *= fact;\n    }\n\
    \    return std::vector<T>(std::begin(f), std::end(f));\n}\n#line 7 \"test/library_checker/number_theory/bell_number.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/library_checker/number_theory/bell_number.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/number_theory/bell_number.test.cpp
- /verify/test/library_checker/number_theory/bell_number.test.cpp.html
