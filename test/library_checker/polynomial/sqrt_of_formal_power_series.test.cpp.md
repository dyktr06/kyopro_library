...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial/sqrt_of_formal_power_series.test.cpp\"\
    ...
    \        for(int i = 1; i < deg; i <<= 1) {\n            res = (res + pre(i <<\
    \ 1) * res.inv(i << 1)) * inv2;\n        }\n        return res.pre(deg);\n   \
    \ }\n};\n#line 6 \"test/library_checker/polynomial/sqrt_of_formal_power_series.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/library_checker/polynomial/sqrt_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/polynomial/sqrt_of_formal_power_series.test.cpp
- /verify/test/library_checker/polynomial/sqrt_of_formal_power_series.test.cpp.html
